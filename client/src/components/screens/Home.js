        ...
        <div className="home">
            {
                data.map(item => {
                    return (
                        <div style={{width: "50%"}} className="card home-card grey darken-4" key={item._id}>
                            ...
                            <div className="card-content white-text">
                                ...
                                >
                                    <input type="text" ref={commentInput} className="input-white validate" placeholder="write a comment" />
                                </form>
                            </div>
                        </div>
                    )
